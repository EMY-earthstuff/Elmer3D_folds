#adapted from Elmer/Ice teaching materials available at http://elmerice.elmerfem.org/courses-tutorials
...
Contour = np.loadtxt('./../Data/contour.dat')
x = Contour[:,0]
y = Contour[:,1]
...
geo = open('synthetic_prognostic.geo', 'w')
